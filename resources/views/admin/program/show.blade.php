<x-layouts.admin-layout>
    ...
    <div class="row gy-4">
        <div class="col-md-12">
            <form action="{{route('program.update',$dataProgram->id)}}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="card-body">
                    <div class="row gy-3">
                        ...
                        <div class="col-6">
                            ...
                            <select name="kategori" class="form-select" readonly>
                                ...
                                <option value="{{$kategori->id}}"
                                    {{ $kategori->id == $dataProgram->kategori_id ? 'selected' : '' }}>
                                    {{ $kategori->nama }}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="kebutuhan" class="form-control rupiah"
                                    placeholder="Masukan kebutuhan dana.. " value="@rupiah($dataProgram->kebutuhan)">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6">
                            ...
                            <select name="tipe_waktu" id="tenggatWaktu" class="form-select">
                                ...
                                <option value="0" {{ $dataProgram->tipe_waktu == 0 ? 'selected' : '' }}>
                                    Tak Terbatas
                                </option>
                                <option value="1" {{ $dataProgram->tipe_waktu == 1 ? 'selected' : '' }}>
                                    Tentukan Waktu
                                </option>
                            </select>
                        </div>
                        <div class="col-lg-3" style="display: none;">
                            ...
                            <input type="date" class="form-control" name="waktu"
                                value="{{ $dataProgram->waktu == Null ? '' : \Carbon\Carbon::parse($dataProgram->waktu)->format('Y-m-d') }}">
                        </div>
                        <div class="col-lg-8">
                            <label class="form-label">Deskripsi Singkat/Ajakan</label>
                            <textarea name="desc_singkat" class="form-control" rows="4" cols="50"
                                placeholder="Masukan deskripsi singkat...">{{$dataProgram->desc_singkat}}</textarea>
                        </div>
                        <div class=" col-lg-4">
                            ...
                            <div class="upload-image-wrapper d-flex align-items-center gap-3">
                                <div
                                    ...
                                    <img id="uploaded-img__preview" class="w-100 h-100 object-fit-cover"
                                        src="{{asset('upload/' . $dataProgram->img)}}" alt="image">
                                </div>
                                <label
                        ...
                        <div class="col-12">
                            ...
                            <div class="card basic-data-table radius-12 overflow-hidden">
                                <div class="card-body p-0">
                                    ...
                                    <!-- Editor start -->
                                    <input type="hidden" name="detail_program" value="{{$dataProgram->detail_program}}">
                                    <div id="editor">{!! $dataProgram->detail_program !!}</div>
    ...
    let val = $("#tenggatWaktu").val()
    console.log(val);

    if (val != '0') {
        $("input[name='waktu']").closest('div').show()
        $("#tenggatWaktu").closest('div').removeClass('col-lg-6')
        $("#tenggatWaktu").closest('div').addClass('col-lg-3')
    } else {
        $("#tenggatWaktu").closest('div').addClass('col-lg-6')
        $("#tenggatWaktu").closest('div').removeClass('col-lg-3')
