<x-app-layout>
    ...
    <div class="px-4 py-8 text-gray-600 text-center">
        <h2 class="font-bold text-xl mb-1 text-gray-900">Terima kasih atas niat baik anda😊</h2>
        <p class="mb-5">Sayang donasimu dengan nomor <br><span
                class=" font-semibold text-red-500">{{ $donasi->kode }}</span><br>sudah melewati batas waktu
            pembayaran
        </p>
        <a class="block w-full py-2 px-8 my-2 text-sm border-2 text-white border-blue bg-blue rounded-md font-semibold"
            href="{{route('donasi',$donasi->program->slug)}}">Ulangi donasi</a>
        <span class="font-italic font-medium">atau</span>
